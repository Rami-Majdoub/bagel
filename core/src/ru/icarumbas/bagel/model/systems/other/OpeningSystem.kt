...
import ru.icarumbas.bagel.model.components.other.DoorComponent
import ru.icarumbas.bagel.model.components.other.OpenComponent
...
class OpeningSystem : IteratingSystem{
    ...
    constructor(uiListener: UIController, rm: RoomManager, deleteList: ArrayList<Entity>, lootCreator: LootCreator) : super(Family.all(OpenComponent::class.java).get()) {
