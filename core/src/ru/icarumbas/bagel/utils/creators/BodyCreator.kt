...
object BodyCreator {
    ...
    fun createPlayerBody(world: World): Body {
        ...
        fixtureDef.filter.maskBits = GROUND_BIT or PLATFORM_BIT or WEAPON_BIT or SHARP_BIT or KEY_OPEN_BIT or AI_BIT
    ...
    fun createSwordWeapon(world: World, categoryBit: Short, maskBit: Short, size: Vector2): Body {
    ...
    fun definePolylineMapObjectBody(world: World, obj: PolylineMapObject, type: BodyDef.BodyType, cBit: Short, mBit: Short = -1): Body {
        val def = BodyDef()
        def.type = type
    ...
    fun defineRectangleMapObjectBody(world: World,
                                     rect: Rectangle,
